...
//    @PUT
//    @Path("{id: \\d+}")
//    public empleadoDTO updateAnimal(@PathParam("id") Long id, empleadoDTO empleadolDto){
//        empleadoEntity empleadoEntity = empleadosLogic.obtenerEmpleados(id);
//        if(empleadoEntity == null){
//            throw new RuntimeException("El animal no existe.");
//        }
//        return new empleadoDTO(empleadosLogic.actualizarEmpleado(id, empleadolDto.toEntity()));
//    }
//    
//    @DELETE
//    @Path("{empleadoId: \\d+}")
//    public void deleteAnimal(@PathParam("empleadoId") Long id){
//        empleadoEntity animalEntity = empleadosLogic.eliminarEmpleado(id);
